	...
	if(strlen($imagename))
	{
		...
		if(in_array($ext,$valid_formats))
		{
			if($size<(1024*1024))
			{
				...
				{	
				  $qry=$DBcon->query("INSERT INTO dr (dr_name, dr_email, dr_cont, dr_addr, dr_expi, dr_edu, dr_flag, dr_date, sp_id, pro_pic, city_id, dr_pass) VALUES ('$u_name','$email', '$cont', '$addr', '$expi', '$edu', '$dr_flag', '$dr_date', '$speci', '$actual_image_name', '$city_id','$password')");
				 if($qry==true)
				{	
				echo "Success" ;
				}else
